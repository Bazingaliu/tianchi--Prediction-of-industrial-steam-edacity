...
def load_train_data():
    df = pd.read_csv(r"C:\Users\Lenovo\Desktop\competition\tianchi\gongyezhenqi-predict\zhengqi_train.txt", header=0, sep="\s+")
    #print(df.describe())
...
def load_test_data():
    df = pd.read_csv(r"C:\Users\Lenovo\Desktop\competition\tianchi\gongyezhenqi-predict\zhengqi_test.txt", header=0, sep="\s+")
    #print(df.describe())
    X_test = df
    return X_test
